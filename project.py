...
# setupUI, retranslateUi, display, display2 --- Created by: PyQt5 UI code generator 5.9.2
...
class Ui_MainWindow(object):
    # UI setups autogenerated by pyqt5 designer
    ...
    def lol_present_info(self):
        _translate = QtCore.QCoreApplication.translate
        self.lol_view_more.setText(_translate("MainWindow", "View more history"))
        try:
    ...
    def lol_present_img(self):
        ...
        for i in range(7):
            items.append(
                self.Summoner.match_details[0]['info']['participants'][self.find_self_participant(0)][f'item{i}'])
        for x in range(10):
